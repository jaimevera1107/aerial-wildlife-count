...
def calculate_detailed_metrics(model, dataset_path, conf_threshold=0.5, iou_threshold=0.5):
    """Calcular métricas detalladas de clasificación para cada clase usando Ultralytics YOLOv8."""
    ...
    try:
        ...
        # Métricas globales preferidas desde results.box
        try:
        ...
        # Completar precision/recall/F1 por clase desde la matriz de confusión si existe
        try:
            ...
            print(f"⚠️ Error usando matriz de confusión: {cm_err}")
...
def calculate_robust_metrics(model, dataset_path, conf_threshold=0.5, iou_threshold=0.5):
    """Función principal que delega al cálculo detallado robusto."""
